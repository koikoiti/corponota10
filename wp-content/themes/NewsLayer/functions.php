<?php
    ...
    if($theme->display('footer_widgets')) {
        ...
        {
            global $theme;
            $theme->display_widget('Text', array('title' => 'Acesso Restrito', 'text' => ' 
		<form action="shopping/login" method="post">
		<input type ="hidden" name="acao" value="acao">
		<div style="width: 40px;">Login:</div><input type="text" name="user" style="width: 100px;" />
		<div style="width: 40px;">Senha:</div><input type="password" name="pass" style="width: 100px;" />
